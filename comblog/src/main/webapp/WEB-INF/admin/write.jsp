...
<body>
<div class="container">
    <form method="post" action="updates.do">
        <br>
        <br>
        <div class="row">
            <div class="col-lg-6">
                    ...
                    <div class="input-group-btn">
                        <c:choose>
                            ...
                            <c:otherwise>
                                <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown"
                                        ...
                                        id="categoryBtn" name="categoryBtn">${category.display_name}
                                </button>
                            </c:otherwise>
                        </c:choose>
                        ...
                        <ul class="dropdown-menu">
                            <c:forEach var="category" items="${categories}">
                                <li>
                                    <a onclick="selectCategory('${category.name}','${category.display_name}');">${category.display_name}</a>
                                </li>
                            </c:forEach>
                        </ul>
                    </div>
