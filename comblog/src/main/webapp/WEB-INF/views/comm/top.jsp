        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav" id="nv1">
                    ...
                    <li id="webPage"><a href="classification.do?id=1">JavaWeb专栏</a></li>
                    <li id="androidPage"><a href="classification.do?id=2">Android专栏</a>
                    </li>
                    <li id="rnPage"><a href="classification.do?id=3">React Native专栏</a>
                    </li>
                    <li id="ubuntuPage"><a href="classification.do?id=4">Ubuntu专栏</a>
                    </li>
                </ul>
